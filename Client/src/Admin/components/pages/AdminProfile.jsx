...
const AdminProfile = () => {
  ...
  // =========================================================
  // SET EDIT FORM WHEN ADMIN DATA LOADS
  // =========================================================
                ...
                >
                  ...
                  <div className="mt-6 flex flex-col-reverse gap-3 border-t border-slate-100 pt-5 sm:flex-row sm:justify-end">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-5 text-sm font-semibold text-slate-600 transition hover:bg-slate-50 disabled:opacity-60"
                    >
                      <X size={17} />
          ...
          <div className="flex flex-col gap-3 border-b border-slate-100 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500 sm:ml-11">
                Keep your admin account secure by updating your password regularly.
              </p>
            ...
            >
              ...
              <div className="mt-5 flex justify-end">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 text-sm font-semibold text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
                >
                  {loading ? (
                    <>
                      <Loader2
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mt-2 max-w-sm text-sm leading-6 text-slate-500">
              Are you sure you want to logout from your Tripora admin account?
            </p>
